...
public class KuhnTrainer {
    ...
    public class KuhnNode {
         ...
         * Effectively, this is updating our strategy for each action based on the
         * regret on a given decision
         * @param realizationWeight Current decision weights
         * @return The array indicating updated decision weights
         */
         ...
         * Finds the average strategy best strategy among all iterations
         * @return The array indicating updated decision weights
         */
